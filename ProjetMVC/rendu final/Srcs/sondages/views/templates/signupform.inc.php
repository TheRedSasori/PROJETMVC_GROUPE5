<form method="post" action="index.php?action=SignUp" class="modal" style="top: 20%">
    ...
    <div class="form-horizontal modal-body">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="signUpLogin" placeholder="Pseudo" required>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="signUpPassword">Mot de passe</label>
            <div class="controls">
                <input type="password" name="signUpPassword" placeholder="Mot de passe" required>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="signUpPassword2">Confirmation</label>
            <div class="controls">
                <input type="password" name="signUpPassword2" placeholder="Confirmation" required>
            </div>
        </div>
    </div>
