...
class Database
{
    ...
    private function createDataBase()
    {
        ...
        $this->connection->exec("ALTER TABLE reponses ADD CONSTRAINT id_surveys FOREIGN KEY(id_surveys) REFERENCES surveys(id)");
    ...
    public function updateUser($nickname, $password)
    {
        ...
        if ($this->checkPasswordValidity($password) === true &&
            ...
            $this->connection->exec("UPDATE users SET password='$pass' WHERE nickname=$nickName");
    ...
    public function saveSurvey($survey)
    {
        ...
        $this->connection->exec("INSERT INTO surveys (owner, question)VALUES( $name, $question)");
    ...
    {
        /* TODO START */
        $this->connection->exec("INSERT INTO responses (title)VALUES( $response)");
